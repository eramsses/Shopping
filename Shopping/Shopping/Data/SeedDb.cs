...
namespace Shopping.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Erick", "Rodriguez", "erick@yopmail.com", "+50432942101", "Valle de Ángeles", "Erick.jpg", UserType.Admin);
            await CheckUserAsync("2020", "Xiomara", "Bustillo", "xiomara@yopmail.com", "+50499944709", "Valle de Ángeles", "Angelina.jpg", UserType.User);
            ...
            await CheckUserAsync("4040", "Bob", "Marley", "bob@yopmail.com", "322 311 4620", "Calle Luna Calle Sol", "bob.jpg", UserType.User);
        ...
        private async Task AddProductAsync(string name, decimal price, float stock, List<string> categories, List<string> images)
        {
            ...
            //Recorrer las categorías para agregarlas
            ...
            //Recorrer las imagenes para agregarlas
