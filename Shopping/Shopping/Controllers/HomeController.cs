...
namespace Shopping.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, DataContext context, IUserHelper userHelper, INotyfService notyf, IOrdersHelper ordersHelper)
        {
            _logger = logger;
            _context = context;
        ...
        public async Task<IActionResult> DecreaseQuantity(int? id)
        {
            ...
            if (temporalSale.Quantity > 1)
            {
                ...
                _notyf.Success("Se eliminó 1 artículo a la cantidad.", 4);
                await _context.SaveChangesAsync();
            }
            else
            {
                _notyf.Error("La cantidad no puede ser menor que 1, si lo desea eliminar use el botón eliminar.", 4);
            }
        ...
        public async Task<IActionResult> IncreaseQuantity(int? id)
        {
            ...
            _context.TemporalSales.Update(temporalSale);
            await _context.SaveChangesAsync();
            _notyf.Success("Se agregó 1 artículo a la cantidad.", 4);
            return RedirectToAction(nameof(ShowCart));
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            await _context.SaveChangesAsync();
            _notyf.Success("Se eliminó 1 artículo del carrito.", 4);
            return RedirectToAction(nameof(ShowCart));
        }
        ...
        public async Task<IActionResult> Edit(int id, EditTemporalSaleViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _notyf.Success("El artículo fue modificado exitosamente", 4);
                    await _context.SaveChangesAsync();
                }
